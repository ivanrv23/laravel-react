...
export default function TablaDinamica({ data, columns }) {
    let emptyProduct = {
        id: null,
        name: "",
        image: null,
        ...
        <div className="m-5">
            ...
            <div className="card">
                ...
                <DataTable
                    ...
                    currentPageReportTemplate="{last} de {totalRecords} Productos"
            ...
            >
                {product.image && (
                    <img
                        ...
                        alt={product.image}
                        className="block pb-3 m-auto product-image"
                    />
                )}
                <div className="field">
            ...
            >
                <div className="confirmation-content">
                    <i
                        className="mr-3 pi pi-exclamation-triangle"
                        style={{ fontSize: "2rem" }}
                    />
                    {product && (
                        <span>
